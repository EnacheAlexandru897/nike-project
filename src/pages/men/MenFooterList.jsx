...
const MenFooterList = (props) => {
  return (
    <li key={props.id} className='max-modf4:w-1/4  max-modf3:w-full ' >
      <p className='text-[21px] font-bold truncate  max-modf:w-[85%] max-modf3:w-full hover:overflow-visible hover:whitespace-normal'>{props.title}</p>
