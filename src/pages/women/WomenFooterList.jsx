...
const WomenFooterList = (props) => {
  return (
    <li key={props.id} className='max-modf4:w-1/4  max-modf3:w-full ' >
      <p className='text-[21px] font-bold truncate  max-modf:w-[85%] modf:w-[85%] max-modf3:w-full hover:overflow-visible hover:whitespace-normal'>{props.title}</p>

      <div className='text-[17px] font-medium text-gray-500 mt-5 space-y-3 max-modf3:hidden truncate  max-modf:w-[85%] flex flex-col'>
...
export default WomenFooterList
